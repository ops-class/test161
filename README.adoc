...
** Check and fail for dirty working trees
** Check and fail for unpushed refs
** Check and fail if it doesn't look like an OS/161 source tree, has
inappropriate files (`.o`), or is too large. (Prevent backend storage DOS
attacks.)
