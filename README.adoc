...
* Test with sys161 2.0.5 changes, including better character dropping support.
* Fix statistics interval support in sys161 2.0.5.
* Split out statistics configuration into separate area.
* Separate collection and recording of stat output.
* Test with shll for lossy shell support.
* Simplify configuration logic for sys161 2.0.5.
